import config
from _future.app.helmholtz_coil.hc_geometry import HelmholtzCoils
from _future.app.helmholtz_coil.plot_util import plot_field_deviation_central_patch, plot_2nd_order_contribution
